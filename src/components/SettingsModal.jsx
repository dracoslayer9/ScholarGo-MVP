...
import { X, User, Shield, FileText, Mail, Trash2, LogOut, CreditCard } from 'lucide-react';
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 rounded-xl border border-bronze/30 bg-gradient-to-br from-white to-bronze/5 relative overflow-hidden">
                                        ...
                                        <div className="mt-4 space-y-2">
                                            {['20x Deep Review & Analysis', '75x Chat AI Assistant', 'Live Score in The Toolbar', 'AI generated text detector', '1500 humanizer words', 'Priority Support'].map((feature, i) => (
