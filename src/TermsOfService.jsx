    ...
    return (
        <div className="min-h-screen bg-white font-sans text-oxford-blue">
            <div className="max-w-3xl mx-auto px-6 py-20">
                ...
                <h1 className="text-4xl font-serif font-bold text-oxford-blue mb-4">Syarat & Ketentuan Scholarstory</h1>
                ...
                <div className="space-y-12">
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-oxford-blue/80 leading-relaxed">
                            <li>Scholarstory adalah strategic workspace berbasis AI yang dirancang untuk tujuan edukasi agar pengguna dapat membedah standar beasiswa dunia dan menyusun narasi esai yang kompetitif secara sistematis.</li>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-oxford-blue/80 leading-relaxed">
                            <li>Kamu memegang hak penuh atas teks esai yang kamu upload ke Scholarstory.</li>
                            <li>Dengan menggunakan layanan kami, kamu memberikan izin kepada Scholarstory untuk memproses data tersebut hanya untuk memberikan hasil analisis.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-oxford-blue/80 leading-relaxed">
                            <li>Analisis yang diberikan Scholarstory di-generate oleh Artificial Intelligence (AI) dan mungkin mengandung kesalahan.</li>
                            <li>Scholarstory tidak menjamin kelulusan beasiswa atau akurasi 100% dari hasil analisis.</li>
